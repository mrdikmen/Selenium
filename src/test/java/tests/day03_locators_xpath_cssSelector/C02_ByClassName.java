...
public class C02_ByClassName {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //category' ler webElement oldugu icin direkt yazdiramayiz (referans yazdirir)

        //bir for each loop ile her bir webElementi ele alip, ustundeki yaziyi yazdiralim
